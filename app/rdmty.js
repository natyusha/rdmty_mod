                ...
                React.createElement("div", {
                    ...
                    React.createElement("div", {className: "text-overlay"}, 
                        React.createElement("div", {className: "stats"}, 
                            ...
                            React.createElement("span", {className: "percentb"}, 
                                this.props.percentageb
                            ),

                            React.createElement("span", {className: "percentc"}, 
                                this.props.percentagec
                            )
                        ), 
                        React.createElement("div", {className: "info"}, 
                            ...
                            React.createElement("span", {className: "character-star"}, 
                                ""
                            ), 
            ...
            React.createElement("div", {className: ("header " + (this.state.expanded ? '' : 'collapsed'))}, 
                React.createElement("div", {className: "encounter-header"}, 
                    React.createElement("div", {className: "encounter-data ff-header"}, 
                        ...
                        React.createElement("span", {className: "brackets"}, 
                            "["
                        ), 
                        ...
                        React.createElement("span", {className: "raidDPS"}, 
                    ...
                    React.createElement("div", {className: "chart-view-switcher"},
                        React.createElement("span", {className: this.props.currentView,
                ...
                React.createElement("div", {className: "extra-details"}, 
                    React.createElement("div", {className: "extra-row damage"}, 
                        React.createElement("div", {className: "cell"}, 
                            ...
                            React.createElement("span", {className: "value ff-text-damage"}, 
                                encounter.damage
                            )
                        ), 
                        React.createElement("div", {className: "cell"}, 
                    ...
                    React.createElement("div", {className: "extra-row healing"}, 
                        React.createElement("div", {className: "cell"}, 
                            React.createElement("span", {className: "label ff-header"}, "Healing"), 
                            React.createElement("span", {className: "value ff-text-heals"}, 
                                encounter.healed
                            )
                        ), 
                        React.createElement("div", {className: "cell"}, 
                ...
                if (this.props.currentView === 'healing') {
                    if (parseInt(combatant.healed, 10) > 0) {
                        ...
                        stats = {
                            ...
                            totalFormatted: combatant.healed,
                            perSecond: padNumber(combatant['healed%'],4)+'\u2007',
                            additional: combatant.enchps+'\u2007',
                            percentage: padNumber(combatant.OverHealPct,4)+'\u2007',
                            percentageb: padNumber(combatant['critheal%'],4)
                        }
                    }
                }
                    ...
                    if (parseInt(combatant.damagetaken, 10) > 0) {
                        ...
                        stats = {
                            ...
                            totalFormatted: combatant.damagetaken,
                            perSecond: padNumber(combatant.ParryPct,4)+'\u2007',
                            additional: combatant.deaths+'\u2007\u2007',
                            percentage: padNumber(combatant.BlockPct,4)
                        }
                    }
                }
                else {
                    ...
                    stats = {
                        ...
                        totalFormatted: combatant.damage,
                        perSecond: padNumber(combatant['damage%'],4)+'\u2007',
                        additional: combatant.encdps+'\u2007',
                        percentage: padNumber(combatant.DirectHitPct,4)+'\u2007',
                        percentageb: padNumber(combatant['crithit%'],4)+'\u2007',
                        percentagec: padNumber(combatant.CritDirectHitPct,4)
                    }
                }
        ...
        return (
            React.createElement("div", {
                ...
                React.createElement(Header, {
                    ...
                    currentHeader: this.props.chartHeader[this.state.currentViewIndex]}
                    ), 
