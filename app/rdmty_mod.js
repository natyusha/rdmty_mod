...
var formatNumber = function formatNumber(number) {
    ...
    if (number >= 1000) {
        ...
        return (number / 1000000).toFixed(1) + 'mm';
    }
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                formatNumber(DataSource.damage)
                            )
                        ),
                        React.createElement(
                            'div',
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'span',
                                { className: 'value ff-text-heals' },
                                formatNumber(DataSource.healed)
                            )
                        ),
                        React.createElement(
                            'div',
                            ...
                            React.createElement(
                                'span',
                                { className: 'value ff-text-heals' },
                                formatNumber(DataSource.enchps)
                            )
                        ),                        
                        React.createElement(
                            'div',
